...
function App() {
  ...
  const contractAddress = "0x04aca09F51C085b2fb6623Ca290AB63D4cB6EcEb";
      ...
      : (
        <Container fixed sx={{
          ...
          <Typography gutterBottom variant="h6" component="div" fontStyle="italic">
            Click 'Show my Doc' to view your Doc!
          </Typography>
        </Container>
      )
  )
    ...
    <Box>
      ...
      {showAlert && (
        <Alert sx={{
          ...
          <AlertTitle>No Doc Found for this user</AlertTitle>
